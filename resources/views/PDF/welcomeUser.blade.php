...
<head>
  ...
  <title>Thank your for register with us</title>
  <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 font-weight: normal; text-decoration: none" target="_blank" title="RudraXp Logo Image">
                                  <img align="none" alt="" height="32" src="https://photos.google.com/share/AF1QipO4-WLFcqGEOSiua6Fey1XzSA2S4ilYLCm3CPW416htOCReSQxR0ORmR0yjX9V8cg/photo/AF1QipOhbb0pxzzjmD-L5yH1zs-vWopsWSa1TlJjwV1p?key=cjRSSHVta0lPV2tjaTNETnJRczU1ZTUtaHh2YkZB" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 text-decoration: none; height: auto; width: 107px; height: 32px; margin: 0px;" width="107" /> <h2>RudraXP</h2>
                                </a>
                              </td>
                            </tr>
                          </tbody>
 ...
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #f57153; font-weight: normal; text-decoration: none" target="_blank" title="">
                                    <img align="center" alt="Forgot your password?" class="mcnImage" src="http://sanghavi.co.in/images/view1.png" style="-ms-interpolation-mode: bicubic; border: 0; height: 150px;width:150px; outline: none;
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                ...
                                <h1 class="null" style='color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 15px; font-style: normal; font-weight: bold; line-height: 125%; letter-spacing: 2px; text-align: center; display: block; margin: 0; padding: 0'><span style="text-transform:uppercase">Welcome</span></h1>


                                <h2 class="null" style='color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 25px; font-style: normal; font-weight: bold; line-height: 125%; letter-spacing: 1px; text-align: center; display: block; margin: 0; padding: 0'><span style="text-transform:uppercase">{{$data['user_name']}}</span></h2>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Thank you for register with us.
                                <br>
                                <p>Welcome to RudraXP, Complete new experince for EVENT and Travel.</p>
                          </br>
                              </td>
                            </tr>
                          </tbody>
 ...
 -webkit-text-size-adjust: 100%">
                              ...
                              <h3 style='color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 20px; font-style: normal; font-weight: normal; line-height: 125%; letter-spacing: normal; text-align: center; display: block; margin: 0; padding: 0; text-align: left; width: 100%; font-size: 16px; font-weight: bold; '>What is RduraXP?</h3>
 ...
 text-align: left; text-align: left; font-size: 14px; '>At Rudra Xp, our endeavour is to make the most of the time that you take out for your travel pursuits and embellish them with characteristic, exclusive and rich experiences. We care for the unique perspective, the appreciation of excellence and that which maybe simple but not ordinary.
                              </p>
                              <div style="padding-bottom: 18px;">
                                <a href="https://www.rudraxp.com" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 ...
 Helvetica, sans-serif; font-size: 12px;" valign="top">
                                <div style="text-align: center;">
                                  ...
                                  © Copyright 2019 Rudra Experiences All rights reserved, Powered by Aimbeyond Infotech Pvt. Ltd.</div>
                              </td>
                            </tr>
                            <tbody></tbody>
                          </tbody>
 ...
 100%; -webkit-text-size-adjust: 100%; ">
                          <tbody>
                            <tr>
                              ...
                              <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%">
                                <a href="https://www.instagram.com/rudraxp/" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 ...
 text-decoration: none" width="32" />
                              ...
                              <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%">
                                <a href="https://www.facebook.com/rudraxp" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
