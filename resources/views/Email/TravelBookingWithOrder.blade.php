...
<head>
  ...
  <title>YOUR ORDER RECIVED</title>
  <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 font-weight: normal; text-decoration: none" target="_blank" title="RudraXp Logo Image">
                                  <img align="none" alt="" src="{{$data['logo']}}" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
...
<h2 class="null" style='color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 25px; font-style: normal; font-weight: bold; line-height: 125%; letter-spacing: 1px; text-align: center; display: block; margin: 0; padding: 0'><br/><br/><span style="text-transform:uppercase">Congratulations</span></h2>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 12px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Thank you for your Travel Booking Order, You can see order details into your profile <a href="{{$data['site_url']}}/login">Click Here</a> for Login.
                            ...
                            <tr style="background-color:#fed149">
                             ...
                             <tr >
                              <td align="left" class="mcnButtonBlockInner" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding:5px;" valign="top">
                                <strong>{{$data['moreInfo']['name']}}</strong><br/>
                               {{$data['moreInfo']['address']}}<br/>
                               {{$data['moreInfo']['location']}}<br/>
                               Phone: {{$data['moreInfo']['uphone']}}<br/>
                               Email: {{$data['moreInfo']['uemail']}}
                              </td>
                              
                              <td align="left" class="mcnButtonBlockInner" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding:5px;" valign="top">
                               <strong>{{$data['moreInfo']['company_name']}}</strong><br/>
                               {{$data['moreInfo']['company_address']}}<br/>
                               Phone: {{$data['moreInfo']['mobile']}},{{$data['moreInfo']['phone']}}<br/>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; min-width:100%; font-size:12px" width="100%">
                          <tbody class="mcnButtonBlockOuter">
                            ...
                            <?php } ?>
                             <tr>
                              <td align="center" class="mcnButtonBlockInner" style="border:none;mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding:5px;" valign="top">
                               &nbsp;
                              </td>
                               <td align="center" class="mcnButtonBlockInner" style="border:none;mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding:5px;" valign="top">
                              </td>
