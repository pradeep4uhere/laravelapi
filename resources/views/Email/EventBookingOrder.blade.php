...
<h2 class="null" style='color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 25px; font-style: normal; font-weight: bold; line-height: 125%; letter-spacing: 1px; text-align: center; display: block; margin: 0; padding: 0'><br/><br/><span style="text-transform:uppercase">Congratulations</span></h2>
                                <h1 class="null" style='color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 15px; font-style: normal; font-weight: bold; line-height: 125%; letter-spacing: 2px; text-align: center; display: block; margin: 0; padding: 0'><br/><span style="text-transform:uppercase">Your Order Recived Order No:: {{$data['orderNo']}}</span></h1>
                                <small>Order Date:: {{$data['orderDate']}}</small><br>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 12px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Thank you for your event Booking Order, You can see order details into your profile <a href="{{$data['site_url']}}/login">Click Here</a> for Login.
