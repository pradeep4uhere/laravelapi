...
<head>
  ...
  <title>Reset Your Rudra Password</title>
  <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 100%; background-color: #6c757d; height: 100%; margin: 0; padding: 0; width:
 100%" width="100%">
      <tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color:#d2000c;
 ...
 font-weight: normal; text-decoration: none" target="_blank" title="RudraXp Logo Image">
                                  <img align="none" alt="Image" height="32" src="https://photos.app.goo.gl/XKmWGQeguv6iCUTJ6" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
